# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 10:15:11 2022
...
asset=yf.Ticker("ETH-USD")
ETH = asset.history(period="4y")
...
# 2019
ax[0,0].plot(cumret['2019'], label ='ETH', color ='cornflowerblue')
ax[0,0].plot(cumstg['2019'], label ='Strategy', color ='crimson')
# 2020
ax[0,1].plot(cumret['2020'], label ='ETH', color ='cornflowerblue')
ax[0,1].plot(cumstg['2020'], label ='Strategy', color ='crimson')
# 2021
ax[1,0].plot(cumret['2021'], label ='ETH', color ='cornflowerblue')
ax[1,0].plot(cumstg['2021'], label ='Strategy', color ='crimson')
# 2022
ax[1,1].plot(cumret['2022'], label ='ETH', color ='cornflowerblue')
